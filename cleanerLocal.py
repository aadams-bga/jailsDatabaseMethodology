...
class LocalDataReviewApp:
    def __init__(self, root, csv_path, img_folder):
        ...
        # Set Window to Zoomed/Maximized
        try:
        ...
        # ---------------------------------------------------------
        self.CROP_CONFIG = {
            0: (30, 679, 1652, 154),   # Facility Name
            1: (51, 968, 1168, 128),   # Date
            2: (30, 1117-40, 2435, 267+40),  # Occurrences
        }
        # ---------------------------------------------------------
        ...
        try:
            ...
            # Extract Unique Facility Names for Autosuggest
    ...
    def ensure_columns(self):
        ...
        # Clean up existing data to ensure no NaNs interfere with logic
    ...
    def on_facility_type(self, event):
        ...
        if matches:
            ...
            # Position listbox near the facility text box
    ...
    def select_suggestion(self, event=None):
        # Autofill logic: If nothing selected, pick the first one
